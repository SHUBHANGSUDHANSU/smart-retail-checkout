...
checkout-session history. It also presents readiness by backend component and
the current vision, checkout, and runtime metrics on the Dashboard and detailed
System page; it does not replace the OpenCV interface. See
